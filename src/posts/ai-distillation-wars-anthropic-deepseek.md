...
Model distillation is legitimate. You train a smaller model on outputs from a larger one, so the "student" learns to approximate the "teacher." OpenAI does it for GPT-4o mini. Anthropic does it for Claude Haiku. Standard practice.
